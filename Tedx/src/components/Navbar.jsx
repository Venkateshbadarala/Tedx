    ...
    >
      <div className="flex flex-row items-center justify-around font-bold text-white bg-black sm:p-4 rounded-[10px] w-[100vw] ">
            ...
            >
              ...
              {item.name === 'Editions' && (
                <>
                  ...
                  {isEditionsOpen && (
                    <div className="absolute z-10 flex flex-col p-1 mt-2 bg-white text-[15px] text-black w-[9rem] shadow-lg top-[1rem] left-1/2 transform -translate-x-1/2 rounded-[10px]">
        ...
        <div className="bg-red-600 p-2 rounded-[5px] x-sm:text-[9px] sm:text-[1rem]">
          <a href='https://forms.gle/qCRxJSDycszwVwRe9'>Buy Tickets</a>
        </div>
